...
def main():
    ...
    if args.file_path:
        try:
            gaussians = util_gau.load_ply(args.file_path)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--file_path", type=Path, help="ply path", default="/home/tatp/ws/GreatWall/DLabSim/models/3dgs/qz11/il_env.ply")
